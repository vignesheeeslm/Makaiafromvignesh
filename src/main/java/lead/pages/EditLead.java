...
public class EditLead extends PreAndPost {
	...
	*/	
		...
		new MyHomePage(driver, test).clickleads().clickfindleads().Typefirstname(searchname).clickfindleadssubmit().
		clicksearchedlead().clickeleedit().Typeupdatecompany(Updateform).clickelesmallSubmit();
